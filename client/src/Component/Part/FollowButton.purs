-- | The follow buttons in Rtsv2App don't have enough encapsulated state or behaviors to be a full
...
module Rtsv2App.Component.Part.FollowButton 
  ( followButton
  , follow
  , unfollow
  ) where
...
import Rtsv2App.Capability.Resource.User (class ManageUser, followUser, unfollowUser)
import Rtsv2App.Component.HTML.Utils (css)
import Rtsv2App.Data.Profile (Author, Relation(..))
