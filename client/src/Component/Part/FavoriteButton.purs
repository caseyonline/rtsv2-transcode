-- | The favorite buttons in Rtsv2App don't have enough encapsulated state or behaviors to be a full
...
-- | 
-- | For a more in-depth example of this pattern, see the `Rtsv2App.Component.Part.FollowButton` 
-- | module.
module Rtsv2App.Component.Part.FavoriteButton 
  ( ButtonSize(..)
  , favoriteButton
  , favorite
  , unfavorite
...
import Rtsv2App.Capability.Resource.Article (class ManageArticle, favoriteArticle, unfavoriteArticle)
