...
-- | a critical, widely-used type in Rtsv2App.
-- |
...
-- | rows & records. I've given a *much* fuller treatment of the topic in the `Rtsv2App.Api.Request`
-- | module. If you stil feel unfamiliar with this pattern, I recommend giving that module a read
-- | before coming back to this one.
module Rtsv2App.Data.Article where

import Prelude

import Rtsv2App.Data.PaginatedArray (PaginatedArray)
import Rtsv2App.Data.PreciseDateTime (PreciseDateTime)
import Rtsv2App.Data.Profile (Author, decodeJsonWithAuthor)
...
-- | invalid states in the type system. It's defined in `Rtsv2App.Data.Profile`.
