-- | Rtsv2App uses a REST API for resource management. This module defines endpoints in a data type
...
-- |
-- | This module takes the same approach as the `Rtsv2App.Data.Route` module. For a more in-depth
