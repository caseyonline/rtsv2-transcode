...
module Rtsv2App.Capability.Resource.Article where

import Prelude

import Rtsv2App.Api.Endpoint (ArticleParams, Pagination)
import Rtsv2App.Data.Article (Article, ArticleWithMetadata)
