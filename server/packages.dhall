...
let overrides =
      ...
      , simple-json =
          ...
          , repo = "ssh://git@github.com/srstrong/purescript-simple-json.git"
          , version = "35a225860f49c4451dc87f0e9b941f319044079f"
          }
      ...
      , erl-maps =
          ...
          , repo = "https://github.com/purerl/purescript-erl-maps"
          , version = "d8153fdd97acca910b86bd44f55b6fce2f775264"
          }
      , erl-tuples =
          { dependencies =
            [ "assert", "console", "functions", "prelude", "tuples" ]
          , repo = "ssh://git@github.com/srstrong/purescript-erl-tuples.git"
          , version = "d923dab0d94af6872483bb5952b2652afdc3e95a"
          }
      , erl-stetson =
            upstream.erl-stetson
          ⫽ { version = "ee4f7cf591b38e900bd39e3396243b956587c626"
            , dependencies = [ "erl-cowboy", "routing-duplex" ]
            }
      , erl-cowboy =
          { dependencies = [ "erl-process", "erl-modules" ]
          , repo = "ssh://git@github.com/id3as/purescript-erl-cowboy.git"
          , version = "81e7e8ed5c89aaaacb9df23f181a325811969002"
          }
      ...
      , profunctor-lenses =
          ...
          , version = "1edb1d375c49486c41b46371deed09e6512c2724"
          }
      }
...
let additions =
      { routing-duplex =
          ...
          , version = "eceaba4ee9921250cc6640d5ead98bbfc44310f5"
          }
      , heterogeneous =
          { dependencies =
          ...
          , version = "854e6fe8e52c570954c22275aaf657ef068c73f8"
          }
      }
