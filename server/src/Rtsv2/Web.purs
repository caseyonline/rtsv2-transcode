...
import Rtsv2.Handler.TranscodeServer as TranscodeServerHandler
  ...
  void $ Stetson.configure
       # Stetson.routes
           Public.endpoint
             ...
             , "TranscodeServerT"                            : TranscodeServerHandler.transcode loadConfig Live
             }
