...
import Rtsv2.Agents.StreamRelayInstance (CreateRealyChainPayload)
...
findRelayForChain :: CreateRealyChainPayload -> Effect LocationResp
findRelayForChain payload = do
  ...
  --                 findRelayForChain streamId thisServer
  -- where
  --  pickCandidate = head
